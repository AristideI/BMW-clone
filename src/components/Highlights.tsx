export default function Highlights() {
  return (
    <article className="bg-[#e6e6e6] grid grid-cols-3 grid-rows-7 gap-6 px-[10%] py-12">
      ...
      <section className="bg-[url(/images/two.jpg)] bg-cover w-full row-span-4">
        <section className="w-full h-full bg-black bg-opacity-40 text-white flex flex-col justify-end pb-12">
          <div>
            <div className="px-6">
              <p>Travel</p>
      ...
      <section className="bg-white w-full col-span-1 row-span-3 flex flex-col justify-between pb-8">
        ...
        <div className="mx-6 border-b border-b-black pb-4">
          ...
          <div className="flex justify-between">
            ...
            <p className="font-bold text-xl">From €900</p>
          </div>
        </div>
      </section>
    </article>
